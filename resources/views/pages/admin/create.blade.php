                        ...
                        <div class="panel-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="facebook_url"
                                    value="{{ old('facebook_url') }}" autocomplete="facebook_url" autofocus
                        ...
                        <div class="panel-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="twitter_url"
                                    value="{{ old('twitter_url') }}" autocomplete="twitter_url" autofocus
                    ...
                    <div class="col-md-6">
                        <div class="panel-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="email_url" value="{{ old('email_url') }}"
                        ...
                        <div class="panel-body">
                            <div class="mb-3">
                                ...
                                <input type="radio" id="is_active" name="is_active"
                                    value="1"> Active
                                <input type="radio" id="is_active1" @checked(true) name="is_active" value="0"> In_Active
                                @error('is_active')
                                    <br>
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
