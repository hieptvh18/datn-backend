                    ...
                    <div class="pad-btm form-inline">
                        <div class="row">
                            <div class="col-sm-6 table-toolbar-left">
                                @can('admin-add')
                                <a href="{{ route('account_admins.create') }}" class="btn btn-purple"><i class="demo-pli-add icon-fw"></i>Thêm</a>
                                @endcan
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @can('admin-edit')
                                        <a href="{{ route('account_admins.edit', $item->id) }}" class="label label-table label-success">Chi tiết</a>
                                       @endcan
                                        @can('admin-delete')
