...
<form action="{{route('order.pdf',$order->id)}}" method="post">
    @csrf
    <div class="row">
        <div class="col-xs-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div style="width:90%; margin: 0 auto">
                        <div class="row form-group" style="margin-bottom: 5px; font-size: 15px">
                            <label class="col-sm-2 control-label" style="margin-right: -10px" for="demo-hor-name"><b>Họ tên
                                    khách hàng:</b> </label>

                            <span>{{ $order->customer_name }}</span>
                        </div>
                        <div class="row form-group" style="margin-bottom: 14px; font-size: 15px">
                            <label class="col-sm-2 control-label" style="width: 195px" for="demo-hor-function"><b>Điện thoại
                                    khách hàng:</b> </label>
                            <span>{{ $order->customer_phone }}</span>
                        </div>
                        <div class="row form-group" style="margin-top: -10px; margin-bottom: 14px; font-size: 15px">
                            <label class="col-sm-2 control-label" style="width: 195px" for="demo-hor-function"><b>Hình thức
                                    thanh toán:</b> </label>
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $index => $product)
                                    <tr>
                                        ...
                                        <td>
                                            <textarea placeholder="Nhập hướng dẫn sử dụng" name="hdsd[]" class="form-control" id="" cols="30"
                                                rows="2">@foreach ($arrHdsd as $hd)
                                                    @if ($hd[0] == $product->id)
                                                        {{ltrim($hd[1])}}
                                                    @endif
                                                @endforeach
                    ...
                    <p style="font-size: 16px; text-align: center; margin-top: 35px"><i>Cảm ơn bạn đã đến với Phòng khám nha
                            khoa Đức Nghĩa</i></p>
                </div>
            </div>
