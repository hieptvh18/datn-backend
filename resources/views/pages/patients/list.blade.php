                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        ...
                                        @endif
                                    <td>
                                       <form id="deleteForm{{$patient->id}}" action="{{route('patient.destroy',$patient->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                    <button data-form="deleteForm{{ $patient->id }}" class="label label-table label-danger btn-delete" style="border: none" >Xóa</button>
                                        <a href="{{route('patient.edit',$patient->id)}}" class="label label-table label-warning">
                                           Sửa
                                        </a>
                                    </td>
                                </tr>
