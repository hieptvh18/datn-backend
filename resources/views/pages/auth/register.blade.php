                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('postRegister') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="confirmPassword" autocomplete="password" >
                                <input id="password-confirm" type="hidden" class="form-control" name="role_id" value="1" >
